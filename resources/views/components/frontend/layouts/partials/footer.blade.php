    ...
    <div class = "container">
        <div class = "row text-white g-4">
            <div class = "col-md-6 col-lg-3">
                <a class = "text-uppercase text-decoration-none brand text-white" href = "index.html">Time Travel</a>
            ...
            <div class = "col-md-6 col-lg-3">
                ...
                <ul class = "list-unstyled">
                    ...
                    <li class = "my-3">
                        <a href = "category.html" class = "text-white text-decoration-none text-muted">
